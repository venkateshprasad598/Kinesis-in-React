...
export const startViewer = async () => {
  console.log("Join call as viewer!");
  ...
  viewerState.peerConnectionStatsInterval = setInterval(
    () =>
      peerConnection
        .getStats()
        .then((stats) => console.log("Peer connection stats", stats)),
    1000
  );
